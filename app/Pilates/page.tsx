        ...
        <>
            ...
            <div className='bg-violeta min-h-screen  flex flex-col xl:flex-row  relative  gap-5 pt-24 xl:pt-0  xl:pl-5' id="Pilates">
                <div className={` xl:max-w-1/2 xl:pt-36 text-center ${isOpen ? 'darken' : ''}`}>
                    <h2 className='text-5xl md:text-5xl xl:text-8xl font-bold text-white xl:text-left mb-12'>Pilates con elementos</h2>
                    <p className='text-white text-lg xl:text-2xl mx-2 xl:text-left mb-2 xl:pb-16'> El método proporciona una experiencia completa de bienestar físico y mental, que favorece la postura adecuada, la conciencia corporal, la flexibilidad, la coordinación y el fortalecimiento muscular. A través de la práctica, logramos alcanzar una correcta alineación, prevenir dolores de espalda, fortalecer el núcleo y los músculos, mejorar la circulación sanguínea, reducir el estrés y favorecer la relajación. Conlleva al equilibrio óptimo entre cuerpo y mente, promoviendo una vida saludable y plena.</p>
                ...
                <div className="mx-auto max-w-2xl xl:h-screen mb-12 xl:mb-0 ">
                    <Image src={FotoPilates} alt="pilates" className=" h-full object-cover"/>
                </div>
