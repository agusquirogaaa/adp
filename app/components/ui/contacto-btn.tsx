    ...
    <AnimatePresence initial={false} onExitComplete={() => null}>
      <div className="fixed right-4 md:right-10 bottom-10 flex flex-col items-end z-[99999]">
          ...
          >
            ...
            <div className="content p-6 flex flex-col bg-violetaoscuro">
              ...
              <button
                ...
                className="text-zinc-100  w-full px-4 py-2 md:py-4 border-2 border-verde bg-verde rounded-md font-normal text-sm  mb-4 transition duration-200 hover:shadow-none"
              >
        ...
        <button
          ...
          className="bg-verde  w-14 h-14 rounded-full  flex items-center justify-center hover:scale-105 hover:shadow-xl transition duration-200 shadow-lg"
        >
