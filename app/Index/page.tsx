...
export default function Index() {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 h-screen justify-center items-center bg-violeta pb-24 pt-24 lg:grid-cols-5 md:px-2' id="Inicio">
            <div className='flex flex-col  lg:col-span-3 justify-center items-center'>
                <div className='text-center'>
                    ...
                    <h3 className='text-xl xl:text-2xl text-white mt-2 mx-1 lg:mx-0 max-w-xl lg:text-left'> Te brindo herramientas para despertar la conciencia y potenciar tu bienestar a través del movimiento y las terapias holísticas</h3>
