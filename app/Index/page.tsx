...
export default function Index() {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 h-screen justify-center items-center bg-violeta pb-24 pt-24 lg:grid-cols-5' id="Inicio">
            <div className='flex flex-col  lg:col-span-3 justify-center items-center'>
                <div className='text-center'>
                    <h1 className='text-5xl text-white xs:mx-2 lg:mx-0  mt-5 lg:text-left'>
                        Aires de <span className='text-verde lg:text-left'>Pausa</span>
                    </h1>
                    <h3 className='text-xl text-white mt-2 xs:mx-2 lg:mx-0 max-w-xl lg:text-left'> Te brindamos herramientas para despertar la conciencia y potenciar tu bienestar a través del movimiento y las terapias holísticas</h3>
