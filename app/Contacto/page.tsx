    ...
    return (
        <div className='bg-gray-100 py-24'>
          ...
          <div className="flex items-center justify-center mt-12 gap-4">
            <a href="https://wa.me/+5491134087446?text=Hola%20Andrea,%20quiero%20iniciar%20el%20camino%20hacia%20el%20bienestar" target="_blank" rel="noopener noreferrer" className="mx-2 text-violeta hover:text-violetaoscuro">
              <FaWhatsapp size={34} />
            </a>
